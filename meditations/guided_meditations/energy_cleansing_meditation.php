...
// You can add a check here to ensure that XP never drops below 500:
        ...
        $blossomsGain = ($currentLevel <= 3) ? 10 : 5;
...
<head>
    ...
    <title>Self-Confidence Boost</title>
...
<style>
    body {
        ...
        background-color: darkorange; /* Start with black */
    ...
    @keyframes fadeToImage {
        ...
        100% { background: url('../../pictures/energy_cleansing_meditation_background.jpg') no-repeat center center / cover; }
    }
...
<div class="text">Energy Cleansing Meditation</div>

<div id="meditationContent"></div>

<!-- Audio Element -->
<audio id="meditationMusic" src="../../audio/energy_cleansing_meditation_music.mp3" preload="auto" loop></audio>

<!-- Dialog -->
<audio id="meditationDialog" src="../../audio/energy_cleansing_meditation_dialog.mp3" preload="auto"></audio>
...
<div id="imageContainer" class="image-container" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:1000;">
    <img id="energyCleansingMeditationImage" alt="Energy Cleansing Meditation Image" style="width:100%; height:100%; object-fit:cover; opacity: 0; transition: opacity 2s;">
</div>
...
<div class="description">
    <img src="../../pictures/energy_cleansing_meditation_intro.jpg" alt="Energy Cleansing Meditation" class="intro-image">
    <p></p>
    <p></p>
    <button class="start-button" id="startButton" style="font-family: 'Nunito', sans-serif; background-color:darkorange">Start Meditation</button>
    <button id="pauseButton" style="display: none; opacity: 0; position: fixed; left: 50%; top: 50%; transform: translate(-50%, -50%); background: darkorange; border: none; padding: 20px; border-radius: 10px; cursor: pointer; transition: opacity 0.5s;">
    ...
    <div id="progressContainer" style="display: none; position: fixed; left: 50%; top: 55%; transform: translateX(-50%); width: 80%; height: 50px; background-color: #ddd; border-radius: 5px; cursor: pointer;">
        <div id="progressBar" style="height: 100%; background-color: darkorange; width: 0%; border-radius: 5px; transition: width 0.2s ease-in-out;"></div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const energyCleansingMeditationImage = document.getElementById("energyCleansingMeditationImage");
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateBlossomsAndXP() {
            fetch('energy_cleansing_meditation.php', {
                method: 'POST',
                headers: {
