...
// You can add a check here to ensure that XP never drops below 500:
        ...
        $blossomsGain = ($currentLevel <= 7) ? 10 : 5;
...
<head>
    ...
    <title>Self-Love Meditation</title>
...
<style>
    body {
        ...
        background: linear-gradient(135deg, #8a6d3b, #4f4f4f); /* Start with black */
    ...
    @keyframes fadeToImage {
        0% { background: linear-gradient(135deg, #8a6d3b, #4f4f4f); }
        100% { background: url('../../pictures/selflove_meditation_background.jpg') no-repeat center center / cover; }
    }
...
<div class="text">Self-Love Meditation</div>

<div id="meditationContent"></div>

<!-- Audio Element -->
<audio id="meditationMusic" src="../../audio/selflove_meditation_music.mp3" preload="auto" loop></audio>

<!-- Dialog -->
<audio id="meditationDialog" src="../../audio/selflove_meditation_dialog.mp3" preload="auto"></audio>
...
<div id="imageContainer" class="image-container" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:1000;">
    <img id="selfLoveMeditationImage" alt="Self-Love Meditation Image" style="width:100%; height:100%; object-fit:cover; opacity: 0; transition: opacity 2s;">
</div>
...
<div class="description">
    <img src="../../pictures/selflove_meditation_intro.jpg" alt="Self-Love Meditation" class="intro-image">
    <p></p>
    <p></p>
    <button class="start-button" id="startButton" style="font-family: 'Nunito', sans-serif; background: linear-gradient(135deg, #8a6d3b, #4f4f4f); color: white; border: none; padding: 10px 20px; border-radius: 5px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.2); transition: all 0.3s ease;">
        Start Meditation
    </button>
    <button id="pauseButton" style="display: none; opacity: 0; position: fixed; left: 50%; top: 50%; transform: translate(-50%, -50%); background: linear-gradient(135deg, #8a6d3b, #4f4f4f); border: none; padding: 20px; border-radius: 10px; cursor: pointer; transition: opacity 0.5s;">
    ...
    <div id="progressContainer" style="display: none; position: fixed; left: 50%; top: 55%; transform: translateX(-50%); width: 80%; height: 50px; background-color: #ddd; border-radius: 5px; cursor: pointer;">
        <div id="progressBar" style="height: 100%; background: linear-gradient(135deg, #8a6d3b, #4f4f4f); width: 0%; border-radius: 5px; transition: width 0.2s ease-in-out;"></div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const selfLoveMeditationImage = document.getElementById("selfLoveMeditationImage");
...
<script>
    document.getElementById("startButton").addEventListener("click", function () {
        setTimeout(() => {
            let audio = new Audio("../../selflove_meditation_music.mp3");
            audio.play();
