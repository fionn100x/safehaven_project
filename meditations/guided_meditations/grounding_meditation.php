...
// You can add a check here to ensure that XP never drops below 500:
        ...
        $blossomsGain = ($currentLevel <= 6) ? 10 : 5;
...
<head>
    ...
    <title>Grounding Meditation</title>
...
<style>
    body {
        ...
        background-color: saddlebrown; /* Start with black */
    ...
    @keyframes fadeToImage {
        ...
        100% { background: url('../../pictures/grounding_meditation_background.jpg') no-repeat center center / cover; }
    }
...
<div class="text">Grounding Meditation</div>

<div id="meditationContent"></div>

<!-- Audio Element -->
<audio id="meditationMusic" src="../../audio/grounding_meditation_music.mp3" preload="auto" loop></audio>

<!-- Dialog -->
<audio id="meditationDialog" src="../../audio/grounding_meditation_dialog.mp3" preload="auto"></audio>
...
<div id="imageContainer" class="image-container" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; z-index:1000;">
    <img id="groundingMeditationImage" alt="Grounding Meditation Image" style="width:100%; height:100%; object-fit:cover; opacity: 0; transition: opacity 2s;">
</div>
...
<div class="description">
    <img src="../../pictures/grounding_meditation_intro.jpg" alt="Grounding Meditation" class="intro-image">
    <p></p>
    <p></p>
    <button class="start-button" id="startButton" style="font-family: 'Nunito', sans-serif; background-color: sandybrown; color: black">Start Meditation</button>
    <button id="pauseButton" style="display: none; opacity: 0; position: fixed; left: 50%; top: 50%; transform: translate(-50%, -50%); background: sandybrown; border: none; padding: 20px; border-radius: 10px; cursor: pointer; transition: opacity 0.5s;">
    ...
    <div id="progressContainer" style="display: none; position: fixed; left: 50%; top: 55%; transform: translateX(-50%); width: 80%; height: 50px; background-color: #ddd; border-radius: 5px; cursor: pointer;">
        <div id="progressBar" style="height: 100%; background-color: sandybrown; width: 0%; border-radius: 5px; transition: width 0.2s ease-in-out;"></div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const groundingMeditationImage = document.getElementById("groundingMeditationImage");
...
<script>
    document.getElementById("startButton").addEventListener("click", function () {
        setTimeout(() => {
            let audio = new Audio("../../grounding_meditation_music.mp3");
            audio.play();
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateBlossomsAndXP() {
            fetch('grounding_meditation.php', {
                method: 'POST',
                headers: {
